...
const InfoCard = ({ title, description, image }: {title: string, description: string, image: string}) => (
    <div className={`grid grid-rows-[auto_1fr] rounded-lg bg-white w-[75vw] sm:w-[400px] h-auto hover:shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:animate-lift-up animate-lift-down`}>
